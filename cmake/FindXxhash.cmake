...
if(DEP_XXHASH STREQUAL "BUNDLED")
  message(STATUS "Using bundled Xxhash as requested")
  set(Xxhash_FOUND 1)
  return()
elseif(DEPS STREQUAL "DOWNLOAD" OR DEP_XXHASH STREQUAL "DOWNLOAD")
  ...
  if(NOT TARGET dep_xxhash)
    message(STATUS "Using bundled Xxhash since Xxhash>=${Xxhash_FIND_VERSION} was not found locally")
    set(Xxhash_FOUND 1)
    return()
  endif()
endif()
