...
if(DEP_HIREDIS STREQUAL "BUNDLED")
  message(STATUS "Using bundled Hiredis as requested")
  set(Hiredis_FOUND 1)
  return()
elseif(DEPS STREQUAL "DOWNLOAD" OR DEP_HIREDIS STREQUAL "DOWNLOAD")
  ...
  if(NOT TARGET dep_hiredis)
    message(STATUS "Using bundled Hiredis since Hiredis>=${Hiredis_FIND_VERSION} was not found locally")
    set(Hiredis_FOUND 1)
    return()
  endif()
endif()
