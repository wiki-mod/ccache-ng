...
if(DEP_DOCTEST STREQUAL "BUNDLED")
  message(STATUS "Using bundled Doctest as requested")
  set(Doctest_FOUND 1)
  return()
elseif(DEPS STREQUAL "DOWNLOAD" OR DEP_DOCTEST STREQUAL "DOWNLOAD")
  ...
  if(NOT TARGET dep_doctest)
    message(STATUS "Using bundled Doctest since Doctest>=${Doctest_FIND_VERSION} was not found locally")
    set(Doctest_FOUND 1)
    return()
  endif()
endif()
